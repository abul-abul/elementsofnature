                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="tab_url">
                        <a href="#tab_1" data-toggle="tab">
                            Photo Tour Top background
                        </a>
                    </li>
                    <li class="tab_url">
                        <a href="#tab_2" data-toggle="tab">
                            Photo Tour Footer Background
                        </a>
                    </li>
                    <li style="margin-left: 294px">
                        <a href="{{action('AdminController@getAddPhotoTour')}}">
                            <button type="button" class="btn btn-info"> Add Photo Tour</button>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_0">
                        <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet box red">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-cogs"></i>Photo Tour LIst
                                            </div>
                                            <div class="tools">
                                            ...
                                            <div class="table-scrollable">
                                                <table class="table table-hover">
                                                    ...
                                                    @foreach($phototours as $phototour)
                                                        <tr>
                                                            <td>{{$phototour->title}}</td>
                                                            <td>{{$phototour->description}}</td>
                                                            <td>{{$phototour->location}}</td>
                                                            <td>
                                                                <img style="width: 114px;height: 56px" src="/assets/photo-tour-images/{{$phototour->images}}" alt="">
                                                            </td>
                                                            <td>
                                                                <a href="{{action('AdminController@getEditPhotoTour',$phototour->id)}}">
                                                                    <button class="btn green">
                                                                        <i class="glyphicon glyphicon-pencil"></i>
                                                                    </button>
                                                                </a>
                                                                <button data-href="{{action('AdminController@getDeletePhotoTour',$phototour->id)}}" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger click_del">
                            ...
                            @else
                                <center><h1>Not Photo Tour</h1></center>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="tab-pane" id="tab_1">
                        ...
                        <div class="col-md-12">
                            {!! Form::open(['action' => ['AdminController@postAddPhotoTourBackgroundTop'],'files' => 'true',  ]) !!}
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{action('AdminController@getEditPhotoTourBackground',$backgrounds['id'])}}">
                                                        <button class="btn green">
                                                            <i class="glyphicon glyphicon-pencil"></i>
                                                        </button>
                                                    </a>
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div  class="tab-pane" id="tab_1">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="role" value="phototour">
                                <div style="width: 94%;margin-left: 32px;" class="input-group form-group">
                                    <label class="input-group-btn">
                                    <span class="btn btn-primary">
                                        Browse Top Backgount Image… <input name="images" type="file" style="display: none;" multiple="">
