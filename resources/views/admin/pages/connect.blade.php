                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="tab_url">
                        <a href="#tab_1" data-toggle="tab">
                            Connect Page Top background
                        </a>
                    </li>
                    <li class="tab_url">
                        <a href="#tab_2" data-toggle="tab">
                            Connect Page Footer Background
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_0">
                        <div class="row">
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    @foreach($connects as $connect)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button data-href="{{action('AdminController@getDeleteConnect',$connect->id)}}" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-danger click_del">
                            ...
                            @else
                                <center><h1>Not Messages</h1></center>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="tab-pane" id="tab_1">
                        ...
                        <div class="col-md-12">
                            {!! Form::open(['action' => ['AdminController@postAddConnectBackgroundTop'],'files' => 'true',  ]) !!}
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{action('AdminController@getEditConnectBackground',$backgrounds['id'])}}">
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div  class="tab-pane" id="tab_1">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="role" value="connect">
                                <div style="width: 94%;margin-left: 32px;" class="input-group form-group">
                                    <label class="input-group-btn">
                                    <span class="btn btn-primary">
                                        Browse Top Backgount Image… <input name="images" type="file" style="display: none;" multiple="">
